...
1.    Entrar en [Github](https://github.com/join) y rellenar un formulario como este: ![Registro GitHub](/img/github_join.jpg) 
2.    Nos llegará un correo de verificación que deberemos aceptar.
3.    Una vez verificada la cuCómo crear un proyectoenta ya podemos disfrutar de todas las ventajas que nos ofrece esta plataforma.
